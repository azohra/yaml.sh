...
- Contributor guidance is consolidated: `CONTRIBUTING.md` gains a subsystem gate table and a generated-file map, `VERSIONING.md` records the exact release touchpoints, and the development guide documents corpus conventions and portable AWK and shell idioms.
